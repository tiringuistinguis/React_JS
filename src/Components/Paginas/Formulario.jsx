        ...
        return(
            <div id="elemento">
                ...
                <form action="">
                    ...
                    <input type="text" class="form-control" name="nombre" onChange={ this.cambiarNombre } /><br/>
                    <label htmlFor="">Apellido</label><br/>
                    <input type="text" name="apellido" class="form-control" onChange={ this.cambiarApellido }  /><br/>
